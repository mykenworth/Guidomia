...
/**
 Disclaimer:
 This code is from https://www.ungapps.com/2020/02/create-smooth-dropdown-on-ios-swift-5.html
...
extension DropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.textLabel?.textColor = UIColor.systemGray //UIColor.hexStringToUIColor(hex: "#0C7BC0")
        return cell!
    }
}
